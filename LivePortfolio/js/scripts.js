...
$(function () {
	...
	*/
    ...
    $('.subtitle.subtitle-typed').each(function(){
        ...
        subtitleContainer.typed({
            strings: ["Web Developer", "Back End Developer", "Freelancer"], /* Provide the text content here */
	...
	*/
	...
	$('.top-menu').on('click', 'a', function(){
		...
		/* if mobile */
		if((width < 1200) & $('#home-card').length) {
	...
	*/
	...
	$("#cform").validate({
		...
		submitHandler: function() {
			...
			// 	type: 'post',
			// 	dataType: 'json',
			// 	data: '_token=' + $('meta[name="csrf-token"]').attr('content') + '&name='+ $("#cform").find('input[name="name"]').val() + '&email='+ $("#cform").find('input[name="email"]').val() + '&message=' + $("#cform").find('textarea[name="message"]').val(),
			// 	beforeSend: function() {
			//
			// 	},
			// 	complete: function() {
            ...
            //             $('#cform').fadeOut();
            //             $('.alert-success').delay(200).fadeIn();
            //         } else {
            //             $("#contact-btn").prop('disabled', false);
            //             $('.alert-danger').delay(200).fadeIn();
            //             setTimeout(function() {
